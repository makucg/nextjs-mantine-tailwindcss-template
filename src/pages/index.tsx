			...
			<Container className={classes.container} size='sm'>
				...
				<Group mt='sm'>
					<Tooltip label='NextJS' position='bottom-start'>
						<Image src={`/nextjs-${colorScheme}-logo.svg`} alt='NextJS' width={28} />
					</Tooltip>
				...
				<Group mt='lg' className={classes.badgeLinkContainer}>
					...
					<BadgeLink label='next-seo' href='https://github.com/garmeeh/next-seo' />
					<BadgeLink label='yup' href='https://github.com/jquense/yup' />
					<BadgeLink label='react-hook-form' href='https://react-hook-form.com' />
				...
				<Group mt='4rem' mb='10rem'>
					...
					<Button
						component='a'
						href='https://github.com/makucg/nextjs-mantine-tailwindcss-template'
						color='gray'
						radius='xl'
						size='xs'
						styles={{ inner: { color: 'white' } }}
